 ...
 */
public class PlaceStatusViewHolder extends BaseViewHolder<PlaceBrief> {
    ...
    public PlaceStatusViewHolder(ViewGroup parent) {
        super(parent, R.layout.place_item_status);
    ...
    public void setData(PlaceBrief data) {
        ...
        status.setText(Constant.PlaceStatus[data.getStatus()]);
