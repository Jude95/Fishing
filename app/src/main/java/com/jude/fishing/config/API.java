...
public class API {
    public static class URL{
        ...
        public static final String BASE_URL_DEBUG = "http://120.27.55.225/index.php";
        ...
        public static final String GetNotification = "/user/getNotify";
        ...
        public static final String DeleteBlog = "/weibo/del";
        public static final String ReportBlog = "/common/reportWeibo";
